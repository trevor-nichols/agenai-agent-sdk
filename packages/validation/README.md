...
The package source is `0.2.3` and ships in lockstep with Agent Protocol V8 and
`@agen-ai/agent-runtime@0.2.3`. Its ordinary validator-neutral surface is unchanged from `0.1.0`;
